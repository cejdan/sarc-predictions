...
write.table(simplified_top2000_train, "simplified_top2000_0.85_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top2000_test, "simplified_top2000_0.85_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_forest, "./tuned_forest_top2000_corr0.85_logistic.rds")
