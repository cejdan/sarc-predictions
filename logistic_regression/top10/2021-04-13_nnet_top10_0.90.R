...
write.table(simplified_top10_train, "simplified_top10_0.90_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top10_test, "simplified_top10_0.90_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_nnet, "./tuned_nnet_top10_corr0.90.rds")