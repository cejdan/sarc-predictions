...
write.table(simplified_top10_train, "simplified_top10_0.95_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top10_test, "simplified_top10_0.95_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_forest, "./tuned_forest_top10_corr0.95_logistic.rds")
