...
write.table(simplified_top10_train, "simplified_top10_0.80_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top10_test, "simplified_top10_0.80_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_svm, "./tuned_SVM_top10_mycorr0.80.rds")