...
write.table(simplified_top100_train, "simplified_top100_0.95_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top100_test, "simplified_top100_0.95_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_forest, "./tuned_forest_top100_corr0.95_logistic.rds")
