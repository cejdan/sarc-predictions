...
results_df = data.frame(model = NA, feature_selection = NA, sample = NA, rsq_threshold = NA, 
                        AUC = NA, size = NA, decay = NA, accuracy = NA, kappa = NA, 
...

{
  ...
  temp_df = data.frame(model = model, feature_selection = feature_selection, sample = sample, rsq_threshold = rsq_threshold, 
                       AUC = AUC, size = size, decay = decay, accuracy = accuracy, kappa = kappa, accuracy_null = accuracy_null,
  ...
  rds = readRDS("tuned_nnet_top100_corr0.95.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top100")
  rds = readRDS("tuned_nnet_top100_corr0.85.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top100")
  rds = readRDS("tuned_nnet_top100_corr0.80.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top100")
  rds = readRDS("tuned_nnet_top100_corr0.75.rds")
  ...
  rds = readRDS("tuned_nnet_top500_corr0.95.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top500")
  rds = readRDS("tuned_nnet_top500_corr0.90.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top500")
  rds = readRDS("tuned_nnet_top500_corr0.85.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top500")
  rds = readRDS("tuned_nnet_top500_corr0.80.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top500")
  rds = readRDS("tuned_nnet_top500_corr0.75.rds")
  ...
  rds = readRDS("tuned_nnet_top1000_corr0.95.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top1000")
  rds = readRDS("tuned_nnet_top1000_corr0.90.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top1000")
  rds = readRDS("tuned_nnet_top1000_corr0.85.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top1000")
  rds = readRDS("tuned_nnet_top1000_corr0.80.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top1000")
  rds = readRDS("tuned_nnet_top1000_corr0.75.rds")
  ...
  rds = readRDS("tuned_nnet_top2000_corr0.95.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top2000")
  rds = readRDS("tuned_nnet_top2000_corr0.90.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top2000")
  rds = readRDS("tuned_nnet_top2000_corr0.85.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top2000")
  rds = readRDS("tuned_nnet_top2000_corr0.80.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist1_logistic/top2000")
  rds = readRDS("tuned_nnet_top2000_corr0.75.rds")
  ...
  rds = readRDS("tuned_nnet_lasso_mycorr0.95.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist2_lasso")
  rds = readRDS("tuned_nnet_lasso_mycorr0.90.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist2_lasso")
  rds = readRDS("tuned_nnet_lasso_mycorr0.85.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist2_lasso")
  rds = readRDS("tuned_nnet_lasso_mycorr0.80.rds")
  ...
  setwd("//jetsam/scratch/cgm/Cejda/_thesis/snplist2_lasso")
  rds = readRDS("tuned_nnet_lasso_mycorr0.75.rds")
