...
{
# Random Forest - Logistic - top10 - 0.9
model = "RF"
...
rds = readRDS("tuned_forest_lasso_mycorr0.9.rds")
...
ggplot(data = results_df, aes(x = sample, y=-log10(accuracy_pval), fill = rsq_threshold)) +
  geom_bar(stat="identity", position=position_dodge2(preserve = "single")) +
  coord_cartesian(ylim = c(0,1.5)) +
  ggtitle("Random Forest Results - P-val")
