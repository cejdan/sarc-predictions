...
write.table(simplified_top500_train, "simplified_top500_0.75_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top500_test, "simplified_top500_0.75_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_forest, "./tuned_forest_top500_corr0.75_logistic.rds")
