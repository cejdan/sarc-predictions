...
pairs = find_corr(cor_matrix, 0.85)
...
write.table(lasso_simple, "simplified_lasso_0.85_train.csv", row.names = F, quote = F, sep = ",")
write.table(lasso_simple_test, "simplified_lasso_0.85_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_forest, "./tuned_forest_lasso_mycorr0.85.rds")
