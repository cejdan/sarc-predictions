...
pairs = find_corr(cor_matrix, 0.80)
...
write.table(lasso_simple, "simplified_lasso_0.80_train.csv", row.names = F, quote = F, sep = ",")
write.table(lasso_simple_test, "simplified_lasso_0.80_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_svm, "./tuned_svmRadial_lasso_mycorr0.80.rds")