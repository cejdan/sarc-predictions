...
pairs = find_corr(cor_matrix, 0.75)
...
write.table(lasso_simple, "simplified_lasso_0.75_train.csv", row.names = F, quote = F, sep = ",")
write.table(lasso_simple_test, "simplified_lasso_0.75_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_svm, "./tuned_svmRadial_lasso_mycorr0.75.rds")