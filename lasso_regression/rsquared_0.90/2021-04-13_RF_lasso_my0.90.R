...
pairs = find_corr(cor_matrix, 0.90)
...
write.table(lasso_simple, "simplified_lasso_0.90_train.csv", row.names = F, quote = F, sep = ",")
write.table(lasso_simple_test, "simplified_lasso_0.90_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_forest, "./tuned_forest_lasso_mycorr0.90.rds")
