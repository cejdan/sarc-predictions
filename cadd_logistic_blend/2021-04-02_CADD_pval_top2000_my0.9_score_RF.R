...
write.table(simplified_top2000_train, "simplified_caddpval_top2000_my0.9_SCORES_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top2000_test, "simplified_caddpval_top2000_my0.9_SCORES_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_forest, "./tuned_forest_cadd_pval_top2000_mycorr0.9_score.rds")
