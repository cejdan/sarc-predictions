...
write.table(simplified_top10_train, "simplified_caddpval_top10_0.9_SCORES_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top10_test, "simplified_caddpval_top10_0.9_SCORES_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_svm, "./tuned_svmRadial_cadd_pval_top10_mycorr0.9_score.rds")