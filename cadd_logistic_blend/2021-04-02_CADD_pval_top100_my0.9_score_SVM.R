...
write.table(simplified_top100_train, "simplified_caddpval_top100_0.9_SCORES_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top100_test, "simplified_caddpval_top100_0.9_SCORES_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_svm, "./tuned_svmRadial_cadd_pval_top100_mycorr0.9_score.rds")