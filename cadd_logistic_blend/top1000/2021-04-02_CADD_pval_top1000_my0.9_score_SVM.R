...
write.table(simplified_top1000_train, "simplified_caddpval_top1000_0.9_SCORES_train.csv", row.names = F, quote = F, sep = ",")
write.table(simplified_top1000_test, "simplified_caddpval_top1000_0.9_SCORES_test.csv", row.names = F, quote = F, sep = ",")
...
saveRDS(tuned_svm, "./tuned_svmRadial_cadd_pval_top1000_mycorr0.9_score.rds")